...
// 
// Related Topics 广度优先搜索 数组 哈希表 字符串 👍 425 👎 0
...
public class No_Seven52_OpenTheLock {
    public static void main(String[] args) {
        Solution solution = new No_Seven52_OpenTheLock().new Solution();
    }
    ...
    class Solution {
        public int openLock(String[] deadends, String target) {
            ...
            while (!queue.isEmpty()) {
                ...
                for (int i = 0; i < curSize; i++) {
                    ...
                    //如果遇上死亡数字，就说明“当前死亡数字不能延伸新局面，需要跳过
        ...
        //第i位-1之后的新局面
        private String minuxOne(String cur, int i) {
            char[] curChars = cur.toCharArray();
            if (curChars[i] == '0') {
                curChars[i] = '9';
                return new String(curChars);
